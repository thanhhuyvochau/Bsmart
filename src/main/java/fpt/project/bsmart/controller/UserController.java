...
//    private final IClassService classService;
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<ApiPage<UserDto>>> adminGetUser(@Nullable UserSearchRequest request, Pageable pageable){
        return ResponseEntity.ok(ApiResponse.success(iUserService.adminGetUser(request, pageable)));
    }
