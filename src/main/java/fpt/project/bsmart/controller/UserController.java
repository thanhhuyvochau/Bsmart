...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<Boolean>> uploadDegree(@Nullable @RequestParam List<Long> degreeIdsToDelete, @Nullable @RequestParam("file") MultipartFile[] files) throws IOException {
